    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <div className="mb-4">
              <Image src="/logo.png" alt="Chico's Chili" width={300} height={120} className="object-contain" style={{ maxHeight: "110px", width: "auto" }} />
            </div>
            <p
            ...
            <a
              ...
              style={{ color: "var(--chili-red)", textDecoration: "none" }}
            >
